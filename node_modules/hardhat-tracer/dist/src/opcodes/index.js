...
const mload_1 = __importDefault(require("./mload"));
const msize_1 = __importDefault(require("./msize"));
const mstore_1 = __importDefault(require("./mstore"));
const mstore8_1 = __importDefault(require("./mstore8"));
...
function parse(step, currentAddress) {
    switch (step.opcode.name) {
        ...
        case "MLOAD":
            return mload_1.default.parse(step);
        case "MSIZE":
            return msize_1.default.parse();
        case "MSTORE":
            return mstore_1.default.parse(step);
        case "MSTORE8":
            return mstore8_1.default.parse(step);
        case "SLOAD":
            return sload_1.default.parse(step);
        case "SSTORE":
            return sstore_1.default.parse(step);
        case "SHA3":
            return sha3_1.default.parse(step);
        case "REVERT":
...
async function format(item, dependencies) {
    switch (item.opcode) {
        ...
        case "MLOAD":
            return mload_1.default.format(item);
        case "MSIZE":
            return msize_1.default.format(item);
        case "MSTORE":
            return mstore_1.default.format(item);
        case "MSTORE8":
            return mstore8_1.default.format(item);
        case "SLOAD":
            return sload_1.default.format(item);
        case "SSTORE":
            return sstore_1.default.format(item);
        case "SHA3":
            return sha3_1.default.format(item);
        case "REVERT":
